document.addEventListener("DOMContentLoaded", () => {
  ...
  const langMetaMap = {
    hindi: { code: "hi", dir: "ltr", title: "खिलौने एवं पुतली दीर्घा (Toy and Doll Gallery) | Salar Jung Museum" },
    english: { code: "en", dir: "ltr", title: "Toy and Doll Gallery | Salar Jung Museum" },
    telugu: { code: "te", dir: "ltr", title: "బొమ్మలు మరియు బొమ్మల గ్యాలరీ (Toy and Doll Gallery) | Salar Jung Museum" },
    urdu: { code: "ur", dir: "rtl", title: "کھلونے اور گڑیا گیلری (Toy and Doll Gallery) | Salar Jung Museum" },
    ...
    kannada: { code: "kn", dir: "ltr", title: "ಆಟಿಕೆಗಳು ಮತ್ತು ಕೋCollectibles ಗ್ಯಾಲರಿ (Toy and Doll Gallery) | Salar Jung Museum" },
    odia: { code: "or", dir: "ltr", title: "ଖେଳଣା ଓ କଣ୍ଢେଇ ଗ୍ୟାଲେରୀ (Toy and Doll Gallery) | Salar Jung Museum" },
    marathi: { code: "mr", dir: "ltr", title: "खेळणी आणि बाहुल्या गॅलरी (Toy and Doll Gallery) | Salar Jung Museum" },
