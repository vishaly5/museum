document.addEventListener("DOMContentLoaded", () => {
  ...
  const langMetaMap = {
    ...
    telugu: { code: "te", dir: "ltr", title: "వృక్షజాలం మరియు జంతుజాలం గ్యాలరీ (Flora and Fauna Gallery) | Salar Jung Museum" },
    urdu: { code: "ur", dir: "rtl", title: "پودے اور جانوروں کی گیلری (Flora and Fauna Gallery) | Salar Jung Museum" },
    bengali: { code: "bn", dir: "ltr", title: "উদ্ভিদ ও প্রাণী গ্যালারি (Flora and Fauna Gallery) | Salar Jung Museum" },
    gujarati: { code: "gu", dir: "ltr", title: "વનસ્પતિ અને પ્રાણીસૃષ્ટિ ગેલેરી (Flora and Fauna Gallery) | Salar Jung Museum" },
